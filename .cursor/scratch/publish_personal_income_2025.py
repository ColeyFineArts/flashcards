...
SOURCES = [
    ...
    ("Income", "Art Sales net I8", "39,055.06", "Prior MATCHED $23,055.06 + Belt net $5,000 + Venus EPGC-share net $6,000 + August Fortuna joint net $5,000. Sale 6428 and Aquinas wait on Cost.", "LOCKED green"),
    ...
    ("EPGC LLC", "Art Sales", "14,000 Jan + 136,000 Feb + 76,000 July + 25,000 Oct = 251,000", "Gross sale cash. July = Belt L5 $50,000 + Venus $26,000. October = August Fortuna joint $25,000. Do not dump EOEB $130,270 or other L5 $37,396.32.", "LOCKED"),
    ...
    ("Art Sales tab", "Seals / lots / mosaics / Belt / Venus / August joint", "see rows 70–80", "2022–2024 lots stay. 2025 adds Belt, Venus joint, August Fortuna joint.", "LOCKED"),
    ...
    ("Dump EOEB $130,270 or other L5 $37,396.32 onto P&L", "EOEB remainder is per-invoice UNALLOCATED (proposed FEE, no matching Cost). Not dumped. Belt $50k SALE; remaining L5 is not.", "", "", ""),
