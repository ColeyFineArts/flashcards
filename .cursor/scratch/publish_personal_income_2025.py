...
SOURCES = [
    ...
    ("Income", "Art Sales net I8", "34,055.06", "Prior MATCHED $23,055.06 + Belt net $5,000 + Venus EPGC-share net $6,000. Sale 6428 and Aquinas wait on Cost.", "LOCKED green"),
    ...
    ("EPGC LLC", "Art Sales", "14,000 Jan + 136,000 Feb + 76,000 July = 226,000", "Gross sale cash. July = Belt L5 $50,000 + Venus remittance $26,000. Do not dump EOEB $130,270 or other L5 $37,396.32.", "LOCKED"),
    ...
    ("Dump EOEB $130,270 or other L5 $37,396.32 onto P&L", "Mixed art + consultant. Belt $50k is locked SALE; remaining L5 is not. Invoice split still ASK.", "", "", ""),
